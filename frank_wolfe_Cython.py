...
#This is the change, I went from having an "All_or_Nothing" in python, to "all_or_nothing" in Cython
...
def solver_3_cython(graph, demand, g=None, od=None, past=10, max_iter=100, eps=1e-8, \
	...
	#start timer
    	...
    	#I want to introduce a debugger to see how this works
    	#import pdb; pdb.set_trace()
